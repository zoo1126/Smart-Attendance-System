...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(_translate("Form", "申诉状态"))
        ...
        item.setText(_translate("Form", "申诉开始时间"))
        item = self.tableWidget.horizontalHeaderItem(7)
        item.setText(_translate("Form", "申诉结束时间"))
    ...
    def showAllcomplainapply_table(self):
        com_id=self.getcom_id()
        dep_list = findAllcomplainApply(com_id)
    ...
    def AgreeButton(self):
        ...
        if button:
            ...
            phone = onedep[1]
            begindatetime = onedep[6]
            date = begindatetime.date()
            date = str(date)
            begintime = date + " 00:00:00"
            endtime = date + " 23:59:59"
            res=updateAgreeApply(phone,begintime,endtime,self.gethr_id(),self.tableWidget.item(row, 1).text())
            if res:
                onedep = findApplybyEx(self.tableWidget.item(row, 1).text())
                ...
                QMessageBox.warning(self, "失败", "申诉同意失败！", QMessageBox.Yes)
    ...
    def RefuseButton(self):
        ...
        if button:
            ...
            if sign1 :
                ...
                QMessageBox.warning(self, '失败', '该申诉拒绝失败！', QMessageBox.Yes)
    ...
    def searchfornotext(self):
        ...
        if comboflag and startdateflag:
            ...
            self.showAllcomplainapply_table()
