...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(_translate("Form", "请假申请状态"))
        ...
        item.setText(_translate("Form", "请假开始时间"))
        item = self.tableWidget.horizontalHeaderItem(7)
        item.setText(_translate("Form", "请假结束时间"))
    ...
    def showAllrestapply_table(self):
        com_id=self.getcom_id()

        dep_list = findAllrestApply(com_id)
    ...
    def AgreeButton(self):
        ...
        if button:
            ...
            sign1 = updateAgreeApply(onedep[1], attdatetime, 3, self.gethr_id(), self.tableWidget.item(row, 1).text())
            ...
            if sign1:
                ...
                QMessageBox.warning(self, "失败", "请假同意失败！", QMessageBox.Yes)
    ...
    def RefuseButton(self):
        ...
        if button:
            ...
            if sign1:
                ...
                QMessageBox.warning(self, "失败", "请假拒绝失败！", QMessageBox.Yes)
    ...
    def resetSelection(self):
        self.startdate.setDate(QtCore.QDate.currentDate())
        self.enddate.setDate(QtCore.QDate.fromString(self.startdate.date().toString('yyyy-MM-dd'),'yyyy-MM-dd'))
        self.startdate.lineEdit().setVisible(False)
        self.enddate.lineEdit().setVisible(False)
